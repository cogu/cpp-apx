...
namespace apx_test
{
   ...
   TEST(Node, DeriveProperInitValueRecord_UInt8_Uint16)
   {
      ...
      auto const* first = derived_hv->const_get("First");
      ...
      EXPECT_TRUE(ok);
      auto const* second = derived_hv->const_get("Second");
   ...
   TEST(Node, DeriveProperInitValueRecord_U8U8_U16)
   {
      ...
      EXPECT_TRUE(ok);
      auto const* inner2 = inner_hv->const_get("Inner2");
      ...
      EXPECT_TRUE(ok);
      auto const* outer2_dv = derived_hv->const_get("Outer2");
